...
router.post('/', authenticateToken, requireRole(['admin']), validateUserType, addType);           
router.patch('/:typeId', authenticateToken, requireRole(['admin']), validateUserType, updateType);
